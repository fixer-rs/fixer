...
//         field_map::FieldMap,
//         fixer_test::{
//             FieldEqual, SessionSuiteRig, TEST_FIX_MSG_IN_RESEND_REQUEST_ALL_ADMIN_EXPECT_GAP_FILL,
//         },
//         internal::event::{NEED_HEARTBEAT, PEER_TIMEOUT},
//         message::Message,
//         msg_type::{
//             MSG_TYPE_HEARTBEAT, MSG_TYPE_LOGOUT, MSG_TYPE_RESEND_REQUEST, MSG_TYPE_SEQUENCE_RESET,
...
//         s.ssr.session.session_id.qualifier =
//             TEST_FIX_MSG_IN_RESEND_REQUEST_ALL_ADMIN_EXPECT_GAP_FILL.to_string();
