...
pub const SOCKET_PRIVATE_KEY_BYTES: &str = "SocketPrivateKeyBytes";
pub const SOCKET_CERTIFICATE_BYTES: &str = "SocketCertificateBytes";
pub const SOCKET_CA_BYTES: &str = "SocketCABytes";
...
pub const ALLOW_UNKNOWN_MSG_FIELDS: &str = "AllowUnknownMsgFields";
...
pub const ENABLE_NEXT_EXPECTED_MSG_SEQ_NUM: &str = "EnableNextExpectedMsgSeqNum";
pub const RESET_SEQ_TIME: &str = "ResetSeqTime";
...
pub const IN_CHAN_CAPACITY: &str = "InChanCapacity";
