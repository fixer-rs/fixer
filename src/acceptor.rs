...
pub struct Acceptor<A: Application> {
    app: Arc<Mutex<A>>,
    settings: Settings,
    ...
    session_group: AsyncWaitGroup,
    listener_shutdown: AsyncWaitGroup,
    dynamic_sessions: bool,
    dynamic_qualifier: bool,
    dynamic_qualifier_count: isize,
    // 	dynamic_session_chan:    chan *session
    session_addr: DashMap<Arc<SessionID>, IpAddr>,
    session_host_port: HashMap<Arc<SessionID>, isize>,
