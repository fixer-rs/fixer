...
impl NewOrderMultileg {
    ...
    pub fn new(cl_ord_id: field::ClOrdIDField, side: field::SideField, no_legs: field::NoLegsField, transact_time: field::TransactTimeField, ord_type: field::OrdTypeField) -> Self {
