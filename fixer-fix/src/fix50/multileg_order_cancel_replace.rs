...
/// `MultilegOrderCancelReplace` is the `fix50` `MultilegOrderCancelReplace` type, `MsgType` = AC.
...
impl MultilegOrderCancelReplace {
    ...
    pub fn new(orig_cl_ord_id: field::OrigClOrdIDField, cl_ord_id: field::ClOrdIDField, side: field::SideField, transact_time: field::TransactTimeField, ord_type: field::OrdTypeField) -> Self {
