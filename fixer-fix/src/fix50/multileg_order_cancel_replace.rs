...
impl MultilegOrderCancelReplace {
    ...
    pub fn new(orig_cl_ord_id: field::OrigClOrdIDField, cl_ord_id: field::ClOrdIDField, side: field::SideField, no_legs: field::NoLegsField, transact_time: field::TransactTimeField, ord_type: field::OrdTypeField) -> Self {
