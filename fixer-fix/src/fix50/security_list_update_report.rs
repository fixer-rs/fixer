...
pub struct NoRelatedSymNoUnderlyingSecurityAltID<G>(pub G);

impl<G: Borrow<Group>> NoRelatedSymNoUnderlyingSecurityAltID<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoRelatedSymNoUnderlyingSecurityAltID<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoRelatedSymNoUnderlyingSecurityAltIDRepeatingGroup` is the `NoUnderlyingSecurityAltID` repeating group, Tag 457.
pub struct NoRelatedSymNoUnderlyingSecurityAltIDRepeatingGroup(pub RepeatingGroup);

impl NoRelatedSymNoUnderlyingSecurityAltIDRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoRelatedSymNoUnderlyingSecurityAltID<&mut Group> {
        NoRelatedSymNoUnderlyingSecurityAltID(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoRelatedSymNoUnderlyingSecurityAltID<&Group> {
        NoRelatedSymNoUnderlyingSecurityAltID(self.0.get(i))
    }
...
impl Default for NoRelatedSymNoUnderlyingSecurityAltIDRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoRelatedSymNoUnderlyingStips<G>(pub G);

impl<G: Borrow<Group>> NoRelatedSymNoUnderlyingStips<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoRelatedSymNoUnderlyingStips<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoRelatedSymNoUnderlyingStipsRepeatingGroup` is the `NoUnderlyingStips` repeating group, Tag 887.
pub struct NoRelatedSymNoUnderlyingStipsRepeatingGroup(pub RepeatingGroup);

impl NoRelatedSymNoUnderlyingStipsRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoRelatedSymNoUnderlyingStips<&mut Group> {
        NoRelatedSymNoUnderlyingStips(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoRelatedSymNoUnderlyingStips<&Group> {
        NoRelatedSymNoUnderlyingStips(self.0.get(i))
    }
...
impl Default for NoRelatedSymNoUnderlyingStipsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs<G>(pub G);

impl<G: Borrow<Group>> NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup` is the `NoUndlyInstrumentPartySubIDs` repeating group, Tag 1062.
pub struct NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup(pub RepeatingGroup);

impl NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs<&mut Group> {
        NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs<&Group> {
        NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs(self.0.get(i))
    }
...
impl Default for NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoRelatedSymNoUndlyInstrumentParties<G>(pub G);

impl<G: Borrow<Group>> NoRelatedSymNoUndlyInstrumentParties<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_undly_instrument_party_sub_i_ds(&self) -> Result<NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup::new();
        Ok(NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoRelatedSymNoUndlyInstrumentParties<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_undly_instrument_party_sub_i_ds(&mut self, f: NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoRelatedSymNoUndlyInstrumentPartiesRepeatingGroup` is the `NoUndlyInstrumentParties` repeating group, Tag 1058.
pub struct NoRelatedSymNoUndlyInstrumentPartiesRepeatingGroup(pub RepeatingGroup);

impl NoRelatedSymNoUndlyInstrumentPartiesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoRelatedSymNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoRelatedSymNoUndlyInstrumentParties<&mut Group> {
        NoRelatedSymNoUndlyInstrumentParties(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoRelatedSymNoUndlyInstrumentParties<&Group> {
        NoRelatedSymNoUndlyInstrumentParties(self.0.get(i))
    }
...
impl Default for NoRelatedSymNoUndlyInstrumentPartiesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<G: Borrow<Group>> NoRelatedSym<G> {
    ...
    pub fn get_no_underlying_security_alt_id(&self) -> Result<NoRelatedSymNoUnderlyingSecurityAltIDRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoRelatedSymNoUnderlyingSecurityAltIDRepeatingGroup::new();
        Ok(NoRelatedSymNoUnderlyingSecurityAltIDRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
    ...
    pub fn get_no_underlying_stips(&self) -> Result<NoRelatedSymNoUnderlyingStipsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoRelatedSymNoUnderlyingStipsRepeatingGroup::new();
        Ok(NoRelatedSymNoUnderlyingStipsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
    ...
    pub fn get_no_undly_instrument_parties(&self) -> Result<NoRelatedSymNoUndlyInstrumentPartiesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoRelatedSymNoUndlyInstrumentPartiesRepeatingGroup::new();
        Ok(NoRelatedSymNoUndlyInstrumentPartiesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoRelatedSym<G> {
    ...
    pub fn set_no_underlying_security_alt_id(&mut self, f: NoRelatedSymNoUnderlyingSecurityAltIDRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    pub fn set_no_underlying_stips(&mut self, f: NoRelatedSymNoUnderlyingStipsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    pub fn set_no_undly_instrument_parties(&mut self, f: NoRelatedSymNoUndlyInstrumentPartiesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
impl NoRelatedSymRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoRelatedSymNoUnderlyingSecurityAltIDRepeatingGroup::new().0),
            ...
            Box::new(NoRelatedSymNoUnderlyingStipsRepeatingGroup::new().0),
            ...
            Box::new(NoRelatedSymNoUndlyInstrumentPartiesRepeatingGroup::new().0),
