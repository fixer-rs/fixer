...
impl MarketDataSnapshotFullRefresh {
    ...
    pub fn set_total_volume_traded_date(&mut self, v: String) {
        self.message.body.set_field(tag::TOTAL_VOLUME_TRADED_DATE, FIXString::from(v));
    }
    ...
    pub fn get_total_volume_traded_date(&self) -> Result<String, MessageRejectErrorEnum> {
        ...
        self.message.body.get_field(tag::TOTAL_VOLUME_TRADED_DATE, &mut fld.0)?;
        Ok(fld.value().to_string())
    }
    ...
    pub fn has_total_volume_traded_date(&self) -> bool {
        self.message.body.has(tag::TOTAL_VOLUME_TRADED_DATE)
    }
    ...
    pub fn set_total_volume_traded_time(&mut self, v: String) {
        self.message.body.set_field(tag::TOTAL_VOLUME_TRADED_TIME, FIXString::from(v));
    }
    ...
    pub fn get_total_volume_traded_time(&self) -> Result<String, MessageRejectErrorEnum> {
        ...
        self.message.body.get_field(tag::TOTAL_VOLUME_TRADED_TIME, &mut fld.0)?;
        Ok(fld.value().to_string())
    }
    ...
    pub fn has_total_volume_traded_time(&self) -> bool {
        self.message.body.has(tag::TOTAL_VOLUME_TRADED_TIME)
    }
