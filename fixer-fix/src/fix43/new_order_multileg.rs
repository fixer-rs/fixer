...
impl NewOrderMultileg {
    ...
    pub fn new(cl_ord_id: field::ClOrdIDField, handl_inst: field::HandlInstField, side: field::SideField, transact_time: field::TransactTimeField, ord_type: field::OrdTypeField) -> Self {
