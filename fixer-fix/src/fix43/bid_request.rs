...
/// `BidRequest` is the `fix43` `BidRequest` type, `MsgType` = k.
...
impl BidRequest {
    ...
    pub fn new(client_bid_id: field::ClientBidIDField, bid_request_trans_type: field::BidRequestTransTypeField, total_num_securities: field::TotalNumSecuritiesField, bid_type: field::BidTypeField, trade_type: field::TradeTypeField, basis_px_type: field::BasisPxTypeField) -> Self {
        ...
        msg.body.set_field(tag::TOTAL_NUM_SECURITIES, total_num_securities.0);

        msg.body.set_field(tag::BID_TYPE, bid_type.0);

        msg.body.set_field(tag::TRADE_TYPE, trade_type.0);
    ...
    pub fn set_trade_type(&mut self, v: String) {
        self.message.body.set_field(tag::TRADE_TYPE, FIXString::from(v));
    }

    /// Gets `TradeType`, Tag 418.
    pub fn get_trade_type(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::TradeTypeField::new(String::new());
        self.message.body.get_field(tag::TRADE_TYPE, &mut fld.0)?;
        Ok(fld.value().to_string())
    }
    ...
    pub fn has_trade_type(&self) -> bool {
        self.message.body.has(tag::TRADE_TYPE)
    }
