...
impl NewOrderCross {
    ...
    pub fn new(cross_id: field::CrossIDField, cross_type: field::CrossTypeField, cross_prioritization: field::CrossPrioritizationField, handl_inst: field::HandlInstField, transact_time: field::TransactTimeField, ord_type: field::OrdTypeField) -> Self {
