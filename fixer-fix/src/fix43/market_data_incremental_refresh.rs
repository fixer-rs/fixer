...
impl<G: Borrow<Group>> NoMDEntries<G> {
    ...
    /// Gets `TotalVolumeTradedDate`, Tag 449.
    pub fn get_total_volume_traded_date(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::TotalVolumeTradedDateField::new(String::new());
        self.group().field_map.get_field(tag::TOTAL_VOLUME_TRADED_DATE, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `TotalVolumeTradedDate` is present, Tag 449.
    pub fn has_total_volume_traded_date(&self) -> bool {
        self.group().field_map.has(tag::TOTAL_VOLUME_TRADED_DATE)
    }




    /// Gets `TotalVolumeTradedTime`, Tag 450.
    pub fn get_total_volume_traded_time(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::TotalVolumeTradedTimeField::new(String::new());
        self.group().field_map.get_field(tag::TOTAL_VOLUME_TRADED_TIME, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `TotalVolumeTradedTime` is present, Tag 450.
    pub fn has_total_volume_traded_time(&self) -> bool {
        self.group().field_map.has(tag::TOTAL_VOLUME_TRADED_TIME)
    }
...
impl<G: BorrowMut<Group>> NoMDEntries<G> {
    ...
    /// Sets `TotalVolumeTradedDate`, Tag 449.
    pub fn set_total_volume_traded_date(&mut self, v: String) {
        self.group_mut().field_map.set_field(tag::TOTAL_VOLUME_TRADED_DATE, FIXString::from(v));
    }
    ...
    /// Sets `TotalVolumeTradedTime`, Tag 450.
    pub fn set_total_volume_traded_time(&mut self, v: String) {
        self.group_mut().field_map.set_field(tag::TOTAL_VOLUME_TRADED_TIME, FIXString::from(v));
    }
...
impl NoMDEntriesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            group_element(tag::TOTAL_VOLUME_TRADED_DATE),



            group_element(tag::TOTAL_VOLUME_TRADED_TIME),
