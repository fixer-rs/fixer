...
impl OrderCancelReject {
    ...
    pub fn new(order_id: field::OrderIDField, cl_ord_id: field::ClOrdIDField, orig_cl_ord_id: field::OrigClOrdIDField, ord_status: field::OrdStatusField, cxl_rej_response_to: field::CxlRejResponseToField) -> Self {
