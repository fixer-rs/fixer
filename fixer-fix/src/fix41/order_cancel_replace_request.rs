...
impl OrderCancelReplaceRequest {
    ...
    pub fn new(orig_cl_ord_id: field::OrigClOrdIDField, cl_ord_id: field::ClOrdIDField, handl_inst: field::HandlInstField, symbol: field::SymbolField, side: field::SideField, ord_type: field::OrdTypeField) -> Self {
