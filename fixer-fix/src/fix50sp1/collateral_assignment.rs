...
/// `CollateralAssignment` is the `fix50sp1` `CollateralAssignment` type, `MsgType` = AY.
pub struct CollateralAssignment {
    pub message: Message,
}

impl CollateralAssignment {
    /// Creates a new `CollateralAssignment` with required fields.
    pub fn new(coll_asgn_id: field::CollAsgnIDField, coll_asgn_reason: field::CollAsgnReasonField, coll_asgn_trans_type: field::CollAsgnTransTypeField, transact_time: field::TransactTimeField) -> Self {
        let mut msg = Message::new();
        msg.header.set_field(tag::MSG_TYPE, FIXString::from("AY".to_string()));

        msg.body.set_field(tag::COLL_ASGN_ID, coll_asgn_id.0);

        msg.body.set_field(tag::COLL_ASGN_REASON, coll_asgn_reason.0);

        msg.body.set_field(tag::COLL_ASGN_TRANS_TYPE, coll_asgn_trans_type.0);
    ...
    /// Creates a `CollateralAssignment` from an existing `Message`.
    ...
    /// Sets `CollAsgnID`, Tag 902.
    pub fn set_coll_asgn_id(&mut self, v: String) {
        self.message.body.set_field(tag::COLL_ASGN_ID, FIXString::from(v));
    }

    /// Gets `CollAsgnID`, Tag 902.
    pub fn get_coll_asgn_id(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::CollAsgnIDField::new(String::new());
        self.message.body.get_field(tag::COLL_ASGN_ID, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `CollAsgnID` is present, Tag 902.
    pub fn has_coll_asgn_id(&self) -> bool {
        self.message.body.has(tag::COLL_ASGN_ID)
    }




    /// Sets `CollAsgnReason`, Tag 895.
    pub fn set_coll_asgn_reason(&mut self, v: isize) {
        self.message.body.set_field(tag::COLL_ASGN_REASON, fixer::fix_int::FIXInt::from(v));
    }

    /// Gets `CollAsgnReason`, Tag 895.
    pub fn get_coll_asgn_reason(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::CollAsgnReasonField::new(0);
        self.message.body.get_field(tag::COLL_ASGN_REASON, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `CollAsgnReason` is present, Tag 895.
    pub fn has_coll_asgn_reason(&self) -> bool {
        self.message.body.has(tag::COLL_ASGN_REASON)
    }




    /// Sets `CollAsgnRefID`, Tag 907.
    pub fn set_coll_asgn_ref_id(&mut self, v: String) {
        self.message.body.set_field(tag::COLL_ASGN_REF_ID, FIXString::from(v));
    }

    /// Gets `CollAsgnRefID`, Tag 907.
    pub fn get_coll_asgn_ref_id(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::CollAsgnRefIDField::new(String::new());
        self.message.body.get_field(tag::COLL_ASGN_REF_ID, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `CollAsgnRefID` is present, Tag 907.
    pub fn has_coll_asgn_ref_id(&self) -> bool {
        self.message.body.has(tag::COLL_ASGN_REF_ID)
    }




    /// Sets `CollAsgnTransType`, Tag 903.
    pub fn set_coll_asgn_trans_type(&mut self, v: isize) {
        self.message.body.set_field(tag::COLL_ASGN_TRANS_TYPE, fixer::fix_int::FIXInt::from(v));
    }

    /// Gets `CollAsgnTransType`, Tag 903.
    pub fn get_coll_asgn_trans_type(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::CollAsgnTransTypeField::new(0);
        self.message.body.get_field(tag::COLL_ASGN_TRANS_TYPE, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `CollAsgnTransType` is present, Tag 903.
    pub fn has_coll_asgn_trans_type(&self) -> bool {
        self.message.body.has(tag::COLL_ASGN_TRANS_TYPE)
    }




    /// Sets `CollReqID`, Tag 894.
    pub fn set_coll_req_id(&mut self, v: String) {
        self.message.body.set_field(tag::COLL_REQ_ID, FIXString::from(v));
    }

    /// Gets `CollReqID`, Tag 894.
    pub fn get_coll_req_id(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::CollReqIDField::new(String::new());
        self.message.body.get_field(tag::COLL_REQ_ID, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `CollReqID` is present, Tag 894.
    pub fn has_coll_req_id(&self) -> bool {
        self.message.body.has(tag::COLL_REQ_ID)
    }
    ...
    pub fn set_no_dlvy_inst(&mut self, f: NoDlvyInstRepeatingGroup) {
        self.message.body.set_group(f.0);
    }

    /// Gets `NoDlvyInst`, Tag 85.
    pub fn get_no_dlvy_inst(&self) -> Result<NoDlvyInstRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoDlvyInstRepeatingGroup::new();
        Ok(NoDlvyInstRepeatingGroup(self.message.body.get_group(g.0)?))
    }
    ...
    pub fn set_no_trades(&mut self, f: NoTradesRepeatingGroup) {
        self.message.body.set_group(f.0);
    }

    /// Gets `NoTrades`, Tag 897.
    pub fn get_no_trades(&self) -> Result<NoTradesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoTradesRepeatingGroup::new();
        Ok(NoTradesRepeatingGroup(self.message.body.get_group(g.0)?))
    }
...
pub type RouteOut = fn(msg: CollateralAssignment, session_id: SessionID) -> Result<(), MessageRejectErrorEnum>;
...
/// Returns the begin string, message type, and route function for `CollateralAssignment`.
pub fn route(router: RouteOut) -> Route {
    let r = move |msg: &Message, session_id: SessionID| -> Result<(), MessageRejectErrorEnum> {
        router(CollateralAssignment::from_message(msg.clone()), session_id)
    };
    ("8", "AY", Box::new(r))
}
...
pub struct NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDs<G>(pub G);

impl<G: Borrow<Group>> NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDs<G> {
...
/// `NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDsRepeatingGroup` is the `NoSettlPartySubIDs` repeating group, Tag 801.
pub struct NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDsRepeatingGroup(pub RepeatingGroup);

impl NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDsRepeatingGroup {
    ...
    pub fn add(&mut self) -> NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDs<&mut Group> {
        NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDs<&Group> {
        NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDs(self.0.get(i))
    }
...
impl Default for NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoDlvyInstNoSettlPartyIDs<G>(pub G);

impl<G: Borrow<Group>> NoDlvyInstNoSettlPartyIDs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_settl_party_sub_i_ds(&self) -> Result<NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDsRepeatingGroup::new();
        Ok(NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoDlvyInstNoSettlPartyIDs<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_settl_party_sub_i_ds(&mut self, f: NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDsRepeatingGroup) {
...
/// `NoDlvyInstNoSettlPartyIDsRepeatingGroup` is the `NoSettlPartyIDs` repeating group, Tag 781.
pub struct NoDlvyInstNoSettlPartyIDsRepeatingGroup(pub RepeatingGroup);

impl NoDlvyInstNoSettlPartyIDsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoDlvyInstNoSettlPartyIDsNoSettlPartySubIDsRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoDlvyInstNoSettlPartyIDs<&mut Group> {
        NoDlvyInstNoSettlPartyIDs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoDlvyInstNoSettlPartyIDs<&Group> {
        NoDlvyInstNoSettlPartyIDs(self.0.get(i))
    }
...
impl Default for NoDlvyInstNoSettlPartyIDsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoDlvyInst<G>(pub G);

impl<G: Borrow<Group>> NoDlvyInst<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_settl_party_i_ds(&self) -> Result<NoDlvyInstNoSettlPartyIDsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoDlvyInstNoSettlPartyIDsRepeatingGroup::new();
        Ok(NoDlvyInstNoSettlPartyIDsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoDlvyInst<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_settl_party_i_ds(&mut self, f: NoDlvyInstNoSettlPartyIDsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoDlvyInstRepeatingGroup` is the `NoDlvyInst` repeating group, Tag 85.
pub struct NoDlvyInstRepeatingGroup(pub RepeatingGroup);

impl NoDlvyInstRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoDlvyInstNoSettlPartyIDsRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoDlvyInst<&mut Group> {
        NoDlvyInst(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoDlvyInst<&Group> {
        NoDlvyInst(self.0.get(i))
    }
...
impl Default for NoDlvyInstRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
/// `NoTrades` is an entry in the `NoTrades` repeating group, Tag 897.
pub struct NoTrades<G>(pub G);

impl<G: Borrow<Group>> NoTrades<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_trade_report_id(&self) -> Result<String, MessageRejectErrorEnum> {
        ...
        self.group().field_map.get_field(tag::TRADE_REPORT_ID, &mut fld.0)?;
        Ok(fld.value().to_string())
    }
    ...
    pub fn has_trade_report_id(&self) -> bool {
        self.group().field_map.has(tag::TRADE_REPORT_ID)
    }
    ...
    pub fn get_secondary_trade_report_id(&self) -> Result<String, MessageRejectErrorEnum> {
        ...
        self.group().field_map.get_field(tag::SECONDARY_TRADE_REPORT_ID, &mut fld.0)?;
        Ok(fld.value().to_string())
    }
    ...
    pub fn has_secondary_trade_report_id(&self) -> bool {
        self.group().field_map.has(tag::SECONDARY_TRADE_REPORT_ID)
    }


}

impl<G: BorrowMut<Group>> NoTrades<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_trade_report_id(&mut self, v: String) {
        self.group_mut().field_map.set_field(tag::TRADE_REPORT_ID, FIXString::from(v));
    }
    ...
    pub fn set_secondary_trade_report_id(&mut self, v: String) {
        self.group_mut().field_map.set_field(tag::SECONDARY_TRADE_REPORT_ID, FIXString::from(v));
    }
...
/// `NoTradesRepeatingGroup` is the `NoTrades` repeating group, Tag 897.
pub struct NoTradesRepeatingGroup(pub RepeatingGroup);

impl NoTradesRepeatingGroup {
    /// Creates an empty `NoTrades` group with the template from the FIX spec.
    pub fn new() -> Self {
        let template: GroupTemplate = vec![


            group_element(tag::TRADE_REPORT_ID),



            group_element(tag::SECONDARY_TRADE_REPORT_ID),


        ];
        Self(RepeatingGroup::new(tag::NO_TRADES, template))
    }

    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoTrades<&mut Group> {
        NoTrades(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoTrades<&Group> {
        NoTrades(self.0.get(i))
    }
...
impl Default for NoTradesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<G: Borrow<Group>> NoUnderlyings<G> {
    ...
    /// Gets `CollAction`, Tag 944.
    pub fn get_coll_action(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::CollActionField::new(0);
        self.group().field_map.get_field(tag::COLL_ACTION, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `CollAction` is present, Tag 944.
    pub fn has_coll_action(&self) -> bool {
        self.group().field_map.has(tag::COLL_ACTION)
    }
...
impl<G: BorrowMut<Group>> NoUnderlyings<G> {
    ...
    /// Sets `CollAction`, Tag 944.
    pub fn set_coll_action(&mut self, v: isize) {
        self.group_mut().field_map.set_field(tag::COLL_ACTION, fixer::fix_int::FIXInt::from(v));
    }
