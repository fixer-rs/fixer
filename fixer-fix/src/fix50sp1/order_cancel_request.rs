...
/// `OrderCancelRequest` is the `fix50sp1` `OrderCancelRequest` type, `MsgType` = F.
...
impl OrderCancelRequest {
    ...
    pub fn new(cl_ord_id: field::ClOrdIDField, side: field::SideField, transact_time: field::TransactTimeField) -> Self {
