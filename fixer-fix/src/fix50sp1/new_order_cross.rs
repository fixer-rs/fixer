...
/// `NewOrderCross` is the `fix50sp1` `NewOrderCross` type, `MsgType` = s.
...
impl NewOrderCross {
    ...
    pub fn new(cross_id: field::CrossIDField, cross_type: field::CrossTypeField, cross_prioritization: field::CrossPrioritizationField, transact_time: field::TransactTimeField, ord_type: field::OrdTypeField) -> Self {
