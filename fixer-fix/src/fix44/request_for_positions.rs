...
impl RequestForPositions {
    ...
    pub fn new(pos_req_id: field::PosReqIDField, pos_req_type: field::PosReqTypeField, account: field::AccountField, account_type: field::AccountTypeField, clearing_business_date: field::ClearingBusinessDateField, transact_time: field::TransactTimeField) -> Self {
