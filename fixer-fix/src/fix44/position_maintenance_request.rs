...
impl PositionMaintenanceRequest {
    ...
    pub fn new(pos_req_id: field::PosReqIDField, pos_trans_type: field::PosTransTypeField, pos_maint_action: field::PosMaintActionField, clearing_business_date: field::ClearingBusinessDateField, account: field::AccountField, account_type: field::AccountTypeField, transact_time: field::TransactTimeField) -> Self {
        let mut msg = Message::new();
        msg.header.set_field(tag::MSG_TYPE, FIXString::from("AL".to_string()));

        msg.body.set_field(tag::POS_REQ_ID, pos_req_id.0);
