...
impl AllocationReportAck {
    ...
    pub fn new(alloc_report_id: field::AllocReportIDField, alloc_id: field::AllocIDField, transact_time: field::TransactTimeField, alloc_status: field::AllocStatusField) -> Self {
