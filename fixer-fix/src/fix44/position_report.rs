...
impl PositionReport {
    ...
    pub fn new(pos_maint_rpt_id: field::PosMaintRptIDField, pos_req_result: field::PosReqResultField, clearing_business_date: field::ClearingBusinessDateField, account: field::AccountField, account_type: field::AccountTypeField, settl_price: field::SettlPriceField, settl_price_type: field::SettlPriceTypeField, prior_settl_price: field::PriorSettlPriceField) -> Self {
        ...
        msg.body.set_field(tag::POS_REQ_RESULT, pos_req_result.0);
        ...
        msg.body.set_field(tag::PRIOR_SETTL_PRICE, prior_settl_price.0);
