...
pub struct NoRelatedSymNoTradingSessions<G>(pub G);

impl<G: Borrow<Group>> NoRelatedSymNoTradingSessions<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoRelatedSymNoTradingSessions<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoRelatedSymNoTradingSessionsRepeatingGroup` is the `NoTradingSessions` repeating group, Tag 386.
pub struct NoRelatedSymNoTradingSessionsRepeatingGroup(pub RepeatingGroup);

impl NoRelatedSymNoTradingSessionsRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoRelatedSymNoTradingSessions<&mut Group> {
        NoRelatedSymNoTradingSessions(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoRelatedSymNoTradingSessions<&Group> {
        NoRelatedSymNoTradingSessions(self.0.get(i))
    }
...
impl Default for NoRelatedSymNoTradingSessionsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<G: Borrow<Group>> NoRelatedSym<G> {
    ...
    pub fn get_no_trading_sessions(&self) -> Result<NoRelatedSymNoTradingSessionsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoRelatedSymNoTradingSessionsRepeatingGroup::new();
        Ok(NoRelatedSymNoTradingSessionsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
    ...
    pub fn get_appl_queue_action(&self) -> Result<isize, MessageRejectErrorEnum> {
        ...
        self.group().field_map.get_field(tag::APPL_QUEUE_ACTION, &mut fld.0)?;
        Ok(fld.value())
    }
    ...
    pub fn has_appl_queue_action(&self) -> bool {
        self.group().field_map.has(tag::APPL_QUEUE_ACTION)
    }
    ...
    pub fn get_appl_queue_max(&self) -> Result<isize, MessageRejectErrorEnum> {
        ...
        self.group().field_map.get_field(tag::APPL_QUEUE_MAX, &mut fld.0)?;
        Ok(fld.value())
    }
    ...
    pub fn has_appl_queue_max(&self) -> bool {
        self.group().field_map.has(tag::APPL_QUEUE_MAX)
    }
...
impl<G: BorrowMut<Group>> NoRelatedSym<G> {
    ...
    pub fn set_no_trading_sessions(&mut self, f: NoRelatedSymNoTradingSessionsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    pub fn set_appl_queue_action(&mut self, v: isize) {
        self.group_mut().field_map.set_field(tag::APPL_QUEUE_ACTION, fixer::fix_int::FIXInt::from(v));
    }
    ...
    pub fn set_appl_queue_max(&mut self, v: isize) {
        self.group_mut().field_map.set_field(tag::APPL_QUEUE_MAX, fixer::fix_int::FIXInt::from(v));
    }
...
impl NoRelatedSymRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoRelatedSymNoTradingSessionsRepeatingGroup::new().0),



            group_element(tag::APPL_QUEUE_ACTION),



            group_element(tag::APPL_QUEUE_MAX),
