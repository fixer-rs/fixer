...
impl RequestForPositionsAck {
    ...
    pub fn new(pos_maint_rpt_id: field::PosMaintRptIDField, pos_req_result: field::PosReqResultField, pos_req_status: field::PosReqStatusField, account: field::AccountField, account_type: field::AccountTypeField) -> Self {
