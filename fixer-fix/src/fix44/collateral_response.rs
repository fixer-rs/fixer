...
impl CollateralResponse {
    ...
    pub fn new(coll_resp_id: field::CollRespIDField, coll_asgn_id: field::CollAsgnIDField, coll_asgn_reason: field::CollAsgnReasonField, coll_asgn_resp_type: field::CollAsgnRespTypeField, transact_time: field::TransactTimeField) -> Self {
