...
pub struct NoRelatedSymNoRateSources<G>(pub G);

impl<G: Borrow<Group>> NoRelatedSymNoRateSources<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoRelatedSymNoRateSources<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoRelatedSymNoRateSourcesRepeatingGroup` is the `NoRateSources` repeating group, Tag 1445.
pub struct NoRelatedSymNoRateSourcesRepeatingGroup(pub RepeatingGroup);

impl NoRelatedSymNoRateSourcesRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoRelatedSymNoRateSources<&mut Group> {
        NoRelatedSymNoRateSources(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoRelatedSymNoRateSources<&Group> {
        NoRelatedSymNoRateSources(self.0.get(i))
    }
...
impl Default for NoRelatedSymNoRateSourcesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<G: Borrow<Group>> NoRelatedSym<G> {
    ...
    pub fn get_no_rate_sources(&self) -> Result<NoRelatedSymNoRateSourcesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoRelatedSymNoRateSourcesRepeatingGroup::new();
        Ok(NoRelatedSymNoRateSourcesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoRelatedSym<G> {
    ...
    pub fn set_no_rate_sources(&mut self, f: NoRelatedSymNoRateSourcesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
impl NoRelatedSymRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoRelatedSymNoRateSourcesRepeatingGroup::new().0),
