...
impl ExecutionReport {
    ...
    pub fn set_no_fills(&mut self, f: NoFillsRepeatingGroup) {
        self.message.body.set_group(f.0);
    }

    /// Gets `NoFills`, Tag 1362.
    pub fn get_no_fills(&self) -> Result<NoFillsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoFillsRepeatingGroup::new();
        Ok(NoFillsRepeatingGroup(self.message.body.get_group(g.0)?))
    }
    ...
    pub fn set_no_rate_sources(&mut self, f: NoRateSourcesRepeatingGroup) {
        self.message.body.set_group(f.0);
    }

    /// Gets `NoRateSources`, Tag 1445.
    pub fn get_no_rate_sources(&self) -> Result<NoRateSourcesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoRateSourcesRepeatingGroup::new();
        Ok(NoRateSourcesRepeatingGroup(self.message.body.get_group(g.0)?))
    }


    /// Returns true if `NoRateSources` is present, Tag 1445.
    pub fn has_no_rate_sources(&self) -> bool {
        self.message.body.has(tag::NO_RATE_SOURCES)
    }
...
/// `NoNested4PartySubIDs` is an entry in the `NoNested4PartySubIDs` repeating group, Tag 1413.
pub struct NoFillsNoNested4PartyIDsNoNested4PartySubIDs<G>(pub G);

impl<G: Borrow<Group>> NoFillsNoNested4PartyIDsNoNested4PartySubIDs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    /// Gets `Nested4PartySubID`, Tag 1412.
    pub fn get_nested4_party_sub_id(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::Nested4PartySubIDField::new(String::new());
        self.group().field_map.get_field(tag::NESTED4_PARTY_SUB_ID, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `Nested4PartySubID` is present, Tag 1412.
    pub fn has_nested4_party_sub_id(&self) -> bool {
        self.group().field_map.has(tag::NESTED4_PARTY_SUB_ID)
    }




    /// Gets `Nested4PartySubIDType`, Tag 1411.
    pub fn get_nested4_party_sub_id_type(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::Nested4PartySubIDTypeField::new(0);
        self.group().field_map.get_field(tag::NESTED4_PARTY_SUB_ID_TYPE, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `Nested4PartySubIDType` is present, Tag 1411.
    pub fn has_nested4_party_sub_id_type(&self) -> bool {
        self.group().field_map.has(tag::NESTED4_PARTY_SUB_ID_TYPE)
    }


}

impl<G: BorrowMut<Group>> NoFillsNoNested4PartyIDsNoNested4PartySubIDs<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    /// Sets `Nested4PartySubID`, Tag 1412.
    pub fn set_nested4_party_sub_id(&mut self, v: String) {
        self.group_mut().field_map.set_field(tag::NESTED4_PARTY_SUB_ID, FIXString::from(v));
    }
    ...
    /// Sets `Nested4PartySubIDType`, Tag 1411.
    pub fn set_nested4_party_sub_id_type(&mut self, v: isize) {
        self.group_mut().field_map.set_field(tag::NESTED4_PARTY_SUB_ID_TYPE, fixer::fix_int::FIXInt::from(v));
    }
...
/// `NoFillsNoNested4PartyIDsNoNested4PartySubIDsRepeatingGroup` is the `NoNested4PartySubIDs` repeating group, Tag 1413.
pub struct NoFillsNoNested4PartyIDsNoNested4PartySubIDsRepeatingGroup(pub RepeatingGroup);

impl NoFillsNoNested4PartyIDsNoNested4PartySubIDsRepeatingGroup {
    /// Creates an empty `NoNested4PartySubIDs` group with the template from the FIX spec.
    pub fn new() -> Self {
        let template: GroupTemplate = vec![


            group_element(tag::NESTED4_PARTY_SUB_ID),



            group_element(tag::NESTED4_PARTY_SUB_ID_TYPE),


        ];
        Self(RepeatingGroup::new(tag::NO_NESTED4_PARTY_SUB_I_DS, template))
    }

    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoFillsNoNested4PartyIDsNoNested4PartySubIDs<&mut Group> {
        NoFillsNoNested4PartyIDsNoNested4PartySubIDs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoFillsNoNested4PartyIDsNoNested4PartySubIDs<&Group> {
        NoFillsNoNested4PartyIDsNoNested4PartySubIDs(self.0.get(i))
    }
...
impl Default for NoFillsNoNested4PartyIDsNoNested4PartySubIDsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
/// `NoNested4PartyIDs` is an entry in the `NoNested4PartyIDs` repeating group, Tag 1414.
pub struct NoFillsNoNested4PartyIDs<G>(pub G);

impl<G: Borrow<Group>> NoFillsNoNested4PartyIDs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    /// Gets `Nested4PartyID`, Tag 1415.
    pub fn get_nested4_party_id(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::Nested4PartyIDField::new(String::new());
        self.group().field_map.get_field(tag::NESTED4_PARTY_ID, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `Nested4PartyID` is present, Tag 1415.
    pub fn has_nested4_party_id(&self) -> bool {
        self.group().field_map.has(tag::NESTED4_PARTY_ID)
    }




    /// Gets `Nested4PartyIDSource`, Tag 1416.
    pub fn get_nested4_party_id_source(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::Nested4PartyIDSourceField::new(String::new());
        self.group().field_map.get_field(tag::NESTED4_PARTY_ID_SOURCE, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `Nested4PartyIDSource` is present, Tag 1416.
    pub fn has_nested4_party_id_source(&self) -> bool {
        self.group().field_map.has(tag::NESTED4_PARTY_ID_SOURCE)
    }




    /// Gets `Nested4PartyRole`, Tag 1417.
    pub fn get_nested4_party_role(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::Nested4PartyRoleField::new(0);
        self.group().field_map.get_field(tag::NESTED4_PARTY_ROLE, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `Nested4PartyRole` is present, Tag 1417.
    pub fn has_nested4_party_role(&self) -> bool {
        self.group().field_map.has(tag::NESTED4_PARTY_ROLE)
    }




    /// Gets `NoNested4PartySubIDs`, Tag 1413.
    pub fn get_no_nested4_party_sub_i_ds(&self) -> Result<NoFillsNoNested4PartyIDsNoNested4PartySubIDsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoFillsNoNested4PartyIDsNoNested4PartySubIDsRepeatingGroup::new();
        Ok(NoFillsNoNested4PartyIDsNoNested4PartySubIDsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }


    /// Returns true if `NoNested4PartySubIDs` is present, Tag 1413.
    pub fn has_no_nested4_party_sub_i_ds(&self) -> bool {
        self.group().field_map.has(tag::NO_NESTED4_PARTY_SUB_I_DS)
    }


}

impl<G: BorrowMut<Group>> NoFillsNoNested4PartyIDs<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    /// Sets `Nested4PartyID`, Tag 1415.
    pub fn set_nested4_party_id(&mut self, v: String) {
        self.group_mut().field_map.set_field(tag::NESTED4_PARTY_ID, FIXString::from(v));
    }
    ...
    /// Sets `Nested4PartyIDSource`, Tag 1416.
    pub fn set_nested4_party_id_source(&mut self, v: String) {
        self.group_mut().field_map.set_field(tag::NESTED4_PARTY_ID_SOURCE, FIXString::from(v));
    }
    ...
    /// Sets `Nested4PartyRole`, Tag 1417.
    pub fn set_nested4_party_role(&mut self, v: isize) {
        self.group_mut().field_map.set_field(tag::NESTED4_PARTY_ROLE, fixer::fix_int::FIXInt::from(v));
    }
    ...
    /// Sets `NoNested4PartySubIDs`, Tag 1413.
    pub fn set_no_nested4_party_sub_i_ds(&mut self, f: NoFillsNoNested4PartyIDsNoNested4PartySubIDsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoFillsNoNested4PartyIDsRepeatingGroup` is the `NoNested4PartyIDs` repeating group, Tag 1414.
pub struct NoFillsNoNested4PartyIDsRepeatingGroup(pub RepeatingGroup);

impl NoFillsNoNested4PartyIDsRepeatingGroup {
    /// Creates an empty `NoNested4PartyIDs` group with the template from the FIX spec.
    pub fn new() -> Self {
        let template: GroupTemplate = vec![


            group_element(tag::NESTED4_PARTY_ID),



            group_element(tag::NESTED4_PARTY_ID_SOURCE),



            group_element(tag::NESTED4_PARTY_ROLE),



            Box::new(NoFillsNoNested4PartyIDsNoNested4PartySubIDsRepeatingGroup::new().0),


        ];
        Self(RepeatingGroup::new(tag::NO_NESTED4_PARTY_I_DS, template))
    }

    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoFillsNoNested4PartyIDs<&mut Group> {
        NoFillsNoNested4PartyIDs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoFillsNoNested4PartyIDs<&Group> {
        NoFillsNoNested4PartyIDs(self.0.get(i))
    }
...
impl Default for NoFillsNoNested4PartyIDsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
/// `NoFills` is an entry in the `NoFills` repeating group, Tag 1362.
pub struct NoFills<G>(pub G);

impl<G: Borrow<Group>> NoFills<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    /// Gets `FillExecID`, Tag 1363.
    pub fn get_fill_exec_id(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::FillExecIDField::new(String::new());
        self.group().field_map.get_field(tag::FILL_EXEC_ID, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `FillExecID` is present, Tag 1363.
    pub fn has_fill_exec_id(&self) -> bool {
        self.group().field_map.has(tag::FILL_EXEC_ID)
    }




    /// Gets `FillPx`, Tag 1364.
    pub fn get_fill_px(&self) -> Result<Decimal, MessageRejectErrorEnum> {
        let mut fld = field::FillPxField::new(Decimal::ZERO, 0);
        self.group().field_map.get_field(tag::FILL_PX, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `FillPx` is present, Tag 1364.
    pub fn has_fill_px(&self) -> bool {
        self.group().field_map.has(tag::FILL_PX)
    }




    /// Gets `FillQty`, Tag 1365.
    pub fn get_fill_qty(&self) -> Result<Decimal, MessageRejectErrorEnum> {
        let mut fld = field::FillQtyField::new(Decimal::ZERO, 0);
        self.group().field_map.get_field(tag::FILL_QTY, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `FillQty` is present, Tag 1365.
    pub fn has_fill_qty(&self) -> bool {
        self.group().field_map.has(tag::FILL_QTY)
    }




    /// Gets `NoNested4PartyIDs`, Tag 1414.
    pub fn get_no_nested4_party_i_ds(&self) -> Result<NoFillsNoNested4PartyIDsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoFillsNoNested4PartyIDsRepeatingGroup::new();
        Ok(NoFillsNoNested4PartyIDsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }


    /// Returns true if `NoNested4PartyIDs` is present, Tag 1414.
    pub fn has_no_nested4_party_i_ds(&self) -> bool {
        self.group().field_map.has(tag::NO_NESTED4_PARTY_I_DS)
    }




    /// Gets `FillLiquidityInd`, Tag 1443.
    pub fn get_fill_liquidity_ind(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::FillLiquidityIndField::new(0);
        self.group().field_map.get_field(tag::FILL_LIQUIDITY_IND, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `FillLiquidityInd` is present, Tag 1443.
    pub fn has_fill_liquidity_ind(&self) -> bool {
        self.group().field_map.has(tag::FILL_LIQUIDITY_IND)
    }


}

impl<G: BorrowMut<Group>> NoFills<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    /// Sets `FillExecID`, Tag 1363.
    pub fn set_fill_exec_id(&mut self, v: String) {
        self.group_mut().field_map.set_field(tag::FILL_EXEC_ID, FIXString::from(v));
    }
    ...
    /// Sets `FillPx`, Tag 1364.
    pub fn set_fill_px(&mut self, val: Decimal, scale: i32) {
        self.group_mut().field_map.set_field(tag::FILL_PX, fixer::fix_decimal::FIXDecimal { decimal: val, scale });
    }
    ...
    /// Sets `FillQty`, Tag 1365.
    pub fn set_fill_qty(&mut self, val: Decimal, scale: i32) {
        self.group_mut().field_map.set_field(tag::FILL_QTY, fixer::fix_decimal::FIXDecimal { decimal: val, scale });
    }
    ...
    /// Sets `NoNested4PartyIDs`, Tag 1414.
    pub fn set_no_nested4_party_i_ds(&mut self, f: NoFillsNoNested4PartyIDsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    /// Sets `FillLiquidityInd`, Tag 1443.
    pub fn set_fill_liquidity_ind(&mut self, v: isize) {
        self.group_mut().field_map.set_field(tag::FILL_LIQUIDITY_IND, fixer::fix_int::FIXInt::from(v));
    }
...
/// `NoFillsRepeatingGroup` is the `NoFills` repeating group, Tag 1362.
pub struct NoFillsRepeatingGroup(pub RepeatingGroup);

impl NoFillsRepeatingGroup {
    /// Creates an empty `NoFills` group with the template from the FIX spec.
    pub fn new() -> Self {
        let template: GroupTemplate = vec![


            group_element(tag::FILL_EXEC_ID),



            group_element(tag::FILL_PX),



            group_element(tag::FILL_QTY),



            Box::new(NoFillsNoNested4PartyIDsRepeatingGroup::new().0),



            group_element(tag::FILL_LIQUIDITY_IND),


        ];
        Self(RepeatingGroup::new(tag::NO_FILLS, template))
    }

    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoFills<&mut Group> {
        NoFills(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoFills<&Group> {
        NoFills(self.0.get(i))
    }
...
impl Default for NoFillsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoLegsNoNested3PartyIDsNoNested3PartySubIDs<G>(pub G);

impl<G: Borrow<Group>> NoLegsNoNested3PartyIDsNoNested3PartySubIDs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoLegsNoNested3PartyIDsNoNested3PartySubIDs<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoLegsNoNested3PartyIDsNoNested3PartySubIDsRepeatingGroup` is the `NoNested3PartySubIDs` repeating group, Tag 952.
pub struct NoLegsNoNested3PartyIDsNoNested3PartySubIDsRepeatingGroup(pub RepeatingGroup);

impl NoLegsNoNested3PartyIDsNoNested3PartySubIDsRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoLegsNoNested3PartyIDsNoNested3PartySubIDs<&mut Group> {
        NoLegsNoNested3PartyIDsNoNested3PartySubIDs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoLegsNoNested3PartyIDsNoNested3PartySubIDs<&Group> {
        NoLegsNoNested3PartyIDsNoNested3PartySubIDs(self.0.get(i))
    }
...
impl Default for NoLegsNoNested3PartyIDsNoNested3PartySubIDsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoLegsNoNested3PartyIDs<G>(pub G);

impl<G: Borrow<Group>> NoLegsNoNested3PartyIDs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_nested3_party_sub_i_ds(&self) -> Result<NoLegsNoNested3PartyIDsNoNested3PartySubIDsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoLegsNoNested3PartyIDsNoNested3PartySubIDsRepeatingGroup::new();
        Ok(NoLegsNoNested3PartyIDsNoNested3PartySubIDsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoLegsNoNested3PartyIDs<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_nested3_party_sub_i_ds(&mut self, f: NoLegsNoNested3PartyIDsNoNested3PartySubIDsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoLegsNoNested3PartyIDsRepeatingGroup` is the `NoNested3PartyIDs` repeating group, Tag 948.
pub struct NoLegsNoNested3PartyIDsRepeatingGroup(pub RepeatingGroup);

impl NoLegsNoNested3PartyIDsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoLegsNoNested3PartyIDsNoNested3PartySubIDsRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoLegsNoNested3PartyIDs<&mut Group> {
        NoLegsNoNested3PartyIDs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoLegsNoNested3PartyIDs<&Group> {
        NoLegsNoNested3PartyIDs(self.0.get(i))
    }
...
impl Default for NoLegsNoNested3PartyIDsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<G: Borrow<Group>> NoLegs<G> {
    ...
    pub fn get_no_nested3_party_i_ds(&self) -> Result<NoLegsNoNested3PartyIDsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoLegsNoNested3PartyIDsRepeatingGroup::new();
        Ok(NoLegsNoNested3PartyIDsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoLegs<G> {
    ...
    pub fn set_no_nested3_party_i_ds(&mut self, f: NoLegsNoNested3PartyIDsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
impl NoLegsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoLegsNoNested3PartyIDsRepeatingGroup::new().0),
...
pub struct NoRateSources<G>(pub G);

impl<G: Borrow<Group>> NoRateSources<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoRateSources<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoRateSourcesRepeatingGroup` is the `NoRateSources` repeating group, Tag 1445.
pub struct NoRateSourcesRepeatingGroup(pub RepeatingGroup);

impl NoRateSourcesRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoRateSources<&mut Group> {
        NoRateSources(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoRateSources<&Group> {
        NoRateSources(self.0.get(i))
    }
...
impl Default for NoRateSourcesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
