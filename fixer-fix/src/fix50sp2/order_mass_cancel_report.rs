...
impl OrderMassCancelReport {
    ...
    pub fn new(order_id: field::OrderIDField, mass_cancel_request_type: field::MassCancelRequestTypeField, mass_cancel_response: field::MassCancelResponseField, mass_action_report_id: field::MassActionReportIDField) -> Self {
