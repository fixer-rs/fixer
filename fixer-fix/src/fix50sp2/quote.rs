...
impl Quote {
    ...
    /// Sets `BidSwapPoints`, Tag 1065.
    pub fn set_bid_swap_points(&mut self, val: Decimal, scale: i32) {
        self.message.body.set_field(tag::BID_SWAP_POINTS, fixer::fix_decimal::FIXDecimal { decimal: val, scale });
    }

    /// Gets `BidSwapPoints`, Tag 1065.
    pub fn get_bid_swap_points(&self) -> Result<Decimal, MessageRejectErrorEnum> {
        let mut fld = field::BidSwapPointsField::new(Decimal::ZERO, 0);
        self.message.body.get_field(tag::BID_SWAP_POINTS, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `BidSwapPoints` is present, Tag 1065.
    pub fn has_bid_swap_points(&self) -> bool {
        self.message.body.has(tag::BID_SWAP_POINTS)
    }
    ...
    /// Sets `OfferSwapPoints`, Tag 1066.
    pub fn set_offer_swap_points(&mut self, val: Decimal, scale: i32) {
        self.message.body.set_field(tag::OFFER_SWAP_POINTS, fixer::fix_decimal::FIXDecimal { decimal: val, scale });
    }

    /// Gets `OfferSwapPoints`, Tag 1066.
    pub fn get_offer_swap_points(&self) -> Result<Decimal, MessageRejectErrorEnum> {
        let mut fld = field::OfferSwapPointsField::new(Decimal::ZERO, 0);
        self.message.body.get_field(tag::OFFER_SWAP_POINTS, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `OfferSwapPoints` is present, Tag 1066.
    pub fn has_offer_swap_points(&self) -> bool {
        self.message.body.has(tag::OFFER_SWAP_POINTS)
    }
...
impl<G: Borrow<Group>> NoLegs<G> {
    ...
    /// Gets `LegBidForwardPoints`, Tag 1067.
    pub fn get_leg_bid_forward_points(&self) -> Result<Decimal, MessageRejectErrorEnum> {
        let mut fld = field::LegBidForwardPointsField::new(Decimal::ZERO, 0);
        self.group().field_map.get_field(tag::LEG_BID_FORWARD_POINTS, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `LegBidForwardPoints` is present, Tag 1067.
    pub fn has_leg_bid_forward_points(&self) -> bool {
        self.group().field_map.has(tag::LEG_BID_FORWARD_POINTS)
    }




    /// Gets `LegOfferForwardPoints`, Tag 1068.
    pub fn get_leg_offer_forward_points(&self) -> Result<Decimal, MessageRejectErrorEnum> {
        let mut fld = field::LegOfferForwardPointsField::new(Decimal::ZERO, 0);
        self.group().field_map.get_field(tag::LEG_OFFER_FORWARD_POINTS, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `LegOfferForwardPoints` is present, Tag 1068.
    pub fn has_leg_offer_forward_points(&self) -> bool {
        self.group().field_map.has(tag::LEG_OFFER_FORWARD_POINTS)
    }
...
impl<G: BorrowMut<Group>> NoLegs<G> {
    ...
    /// Sets `LegBidForwardPoints`, Tag 1067.
    pub fn set_leg_bid_forward_points(&mut self, val: Decimal, scale: i32) {
        self.group_mut().field_map.set_field(tag::LEG_BID_FORWARD_POINTS, fixer::fix_decimal::FIXDecimal { decimal: val, scale });
    }
    ...
    /// Sets `LegOfferForwardPoints`, Tag 1068.
    pub fn set_leg_offer_forward_points(&mut self, val: Decimal, scale: i32) {
        self.group_mut().field_map.set_field(tag::LEG_OFFER_FORWARD_POINTS, fixer::fix_decimal::FIXDecimal { decimal: val, scale });
    }
...
impl NoLegsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            group_element(tag::LEG_BID_FORWARD_POINTS),



            group_element(tag::LEG_OFFER_FORWARD_POINTS),
