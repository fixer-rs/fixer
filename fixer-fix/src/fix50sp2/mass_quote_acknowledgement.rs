...
pub struct NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G>(pub G);

impl<G: Borrow<Group>> NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup` is the `NoComplexEventTimes` repeating group, Tag 1494.
pub struct NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup(pub RepeatingGroup);

impl NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<&mut Group> {
        NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<&Group> {
        NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes(self.0.get(i))
    }
...
impl Default for NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDates<G>(pub G);

impl<G: Borrow<Group>> NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDates<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_complex_event_times(&self) -> Result<NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup::new();
        Ok(NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDates<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_complex_event_times(&mut self, f: NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup` is the `NoComplexEventDates` repeating group, Tag 1491.
pub struct NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup(pub RepeatingGroup);

impl NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDates<&mut Group> {
        NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDates(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDates<&Group> {
        NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDates(self.0.get(i))
    }
...
impl Default for NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteSetsNoQuoteEntriesNoComplexEvents<G>(pub G);

impl<G: Borrow<Group>> NoQuoteSetsNoQuoteEntriesNoComplexEvents<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_complex_event_dates(&self) -> Result<NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup::new();
        Ok(NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoQuoteSetsNoQuoteEntriesNoComplexEvents<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_complex_event_dates(&mut self, f: NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoQuoteSetsNoQuoteEntriesNoComplexEventsRepeatingGroup` is the `NoComplexEvents` repeating group, Tag 1483.
pub struct NoQuoteSetsNoQuoteEntriesNoComplexEventsRepeatingGroup(pub RepeatingGroup);

impl NoQuoteSetsNoQuoteEntriesNoComplexEventsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoQuoteSetsNoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteSetsNoQuoteEntriesNoComplexEvents<&mut Group> {
        NoQuoteSetsNoQuoteEntriesNoComplexEvents(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteSetsNoQuoteEntriesNoComplexEvents<&Group> {
        NoQuoteSetsNoQuoteEntriesNoComplexEvents(self.0.get(i))
    }
...
impl Default for NoQuoteSetsNoQuoteEntriesNoComplexEventsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<G: Borrow<Group>> NoQuoteSetsNoQuoteEntries<G> {
    ...
    pub fn get_no_complex_events(&self) -> Result<NoQuoteSetsNoQuoteEntriesNoComplexEventsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteSetsNoQuoteEntriesNoComplexEventsRepeatingGroup::new();
        Ok(NoQuoteSetsNoQuoteEntriesNoComplexEventsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoQuoteSetsNoQuoteEntries<G> {
    ...
    pub fn set_no_complex_events(&mut self, f: NoQuoteSetsNoQuoteEntriesNoComplexEventsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
impl NoQuoteSetsNoQuoteEntriesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoQuoteSetsNoQuoteEntriesNoComplexEventsRepeatingGroup::new().0),
...
impl<G: Borrow<Group>> NoQuoteSets<G> {
    ...
    /// Gets `QuoteSetValidUntilTime`, Tag 367.
    pub fn get_quote_set_valid_until_time(&self) -> Result<Timestamp, MessageRejectErrorEnum> {
        let mut fld = field::QuoteSetValidUntilTimeField::new(Timestamp::UNIX_EPOCH);
        self.group().field_map.get_field(tag::QUOTE_SET_VALID_UNTIL_TIME, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `QuoteSetValidUntilTime` is present, Tag 367.
    pub fn has_quote_set_valid_until_time(&self) -> bool {
        self.group().field_map.has(tag::QUOTE_SET_VALID_UNTIL_TIME)
    }
...
impl<G: BorrowMut<Group>> NoQuoteSets<G> {
    ...
    /// Sets `QuoteSetValidUntilTime`, Tag 367.
    pub fn set_quote_set_valid_until_time(&mut self, v: Timestamp) {
        self.group_mut().field_map.set_field(tag::QUOTE_SET_VALID_UNTIL_TIME, fixer::fix_utc_timestamp::FIXUTCTimestamp {
            time: v,
            precision: fixer::fix_utc_timestamp::TimestampPrecision::Millis,
        });
    }
...
impl NoQuoteSetsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            group_element(tag::QUOTE_SET_VALID_UNTIL_TIME),
