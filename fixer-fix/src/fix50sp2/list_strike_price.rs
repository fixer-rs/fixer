...
pub struct NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G>(pub G);

impl<G: Borrow<Group>> NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup` is the `NoComplexEventTimes` repeating group, Tag 1494.
pub struct NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup(pub RepeatingGroup);

impl NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<&mut Group> {
        NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimes(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<&Group> {
        NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimes(self.0.get(i))
    }
...
impl Default for NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoStrikesNoComplexEventsNoComplexEventDates<G>(pub G);

impl<G: Borrow<Group>> NoStrikesNoComplexEventsNoComplexEventDates<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_complex_event_times(&self) -> Result<NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup::new();
        Ok(NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoStrikesNoComplexEventsNoComplexEventDates<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_complex_event_times(&mut self, f: NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoStrikesNoComplexEventsNoComplexEventDatesRepeatingGroup` is the `NoComplexEventDates` repeating group, Tag 1491.
pub struct NoStrikesNoComplexEventsNoComplexEventDatesRepeatingGroup(pub RepeatingGroup);

impl NoStrikesNoComplexEventsNoComplexEventDatesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoStrikesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoStrikesNoComplexEventsNoComplexEventDates<&mut Group> {
        NoStrikesNoComplexEventsNoComplexEventDates(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoStrikesNoComplexEventsNoComplexEventDates<&Group> {
        NoStrikesNoComplexEventsNoComplexEventDates(self.0.get(i))
    }
...
impl Default for NoStrikesNoComplexEventsNoComplexEventDatesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoStrikesNoComplexEvents<G>(pub G);

impl<G: Borrow<Group>> NoStrikesNoComplexEvents<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_complex_event_dates(&self) -> Result<NoStrikesNoComplexEventsNoComplexEventDatesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoStrikesNoComplexEventsNoComplexEventDatesRepeatingGroup::new();
        Ok(NoStrikesNoComplexEventsNoComplexEventDatesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoStrikesNoComplexEvents<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_complex_event_dates(&mut self, f: NoStrikesNoComplexEventsNoComplexEventDatesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoStrikesNoComplexEventsRepeatingGroup` is the `NoComplexEvents` repeating group, Tag 1483.
pub struct NoStrikesNoComplexEventsRepeatingGroup(pub RepeatingGroup);

impl NoStrikesNoComplexEventsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoStrikesNoComplexEventsNoComplexEventDatesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoStrikesNoComplexEvents<&mut Group> {
        NoStrikesNoComplexEvents(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoStrikesNoComplexEvents<&Group> {
        NoStrikesNoComplexEvents(self.0.get(i))
    }
...
impl Default for NoStrikesNoComplexEventsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<G: Borrow<Group>> NoStrikes<G> {
    ...
    pub fn get_no_complex_events(&self) -> Result<NoStrikesNoComplexEventsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoStrikesNoComplexEventsRepeatingGroup::new();
        Ok(NoStrikesNoComplexEventsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoStrikes<G> {
    ...
    pub fn set_no_complex_events(&mut self, f: NoStrikesNoComplexEventsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
impl NoStrikesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoStrikesNoComplexEventsRepeatingGroup::new().0),
