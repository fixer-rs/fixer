...
impl PositionReport {
    ...
    pub fn set_model_type(&mut self, v: isize) {
        self.message.body.set_field(tag::MODEL_TYPE, fixer::fix_int::FIXInt::from(v));
    }

    /// Gets `ModelType`, Tag 1434.
    pub fn get_model_type(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::ModelTypeField::new(0);
        self.message.body.get_field(tag::MODEL_TYPE, &mut fld.0)?;
        Ok(fld.value())
    }
    ...
    pub fn has_model_type(&self) -> bool {
        self.message.body.has(tag::MODEL_TYPE)
    }
