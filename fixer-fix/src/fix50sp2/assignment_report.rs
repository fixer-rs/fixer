...
/// `AssignmentReport` is the `fix50sp2` `AssignmentReport` type, `MsgType` = AW.
...
impl AssignmentReport {
    ...
    pub fn new(asgn_rpt_id: field::AsgnRptIDField, clearing_business_date: field::ClearingBusinessDateField) -> Self {
