...
pub struct NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G>(pub G);

impl<G: Borrow<Group>> NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup` is the `NoComplexEventTimes` repeating group, Tag 1494.
pub struct NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup(pub RepeatingGroup);

impl NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<&mut Group> {
        NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<&Group> {
        NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes(self.0.get(i))
    }
...
impl Default for NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoMDEntriesNoComplexEventsNoComplexEventDates<G>(pub G);

impl<G: Borrow<Group>> NoMDEntriesNoComplexEventsNoComplexEventDates<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_complex_event_times(&self) -> Result<NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup::new();
        Ok(NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoMDEntriesNoComplexEventsNoComplexEventDates<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_complex_event_times(&mut self, f: NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoMDEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup` is the `NoComplexEventDates` repeating group, Tag 1491.
pub struct NoMDEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup(pub RepeatingGroup);

impl NoMDEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoMDEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoMDEntriesNoComplexEventsNoComplexEventDates<&mut Group> {
        NoMDEntriesNoComplexEventsNoComplexEventDates(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoMDEntriesNoComplexEventsNoComplexEventDates<&Group> {
        NoMDEntriesNoComplexEventsNoComplexEventDates(self.0.get(i))
    }
...
impl Default for NoMDEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoMDEntriesNoComplexEvents<G>(pub G);

impl<G: Borrow<Group>> NoMDEntriesNoComplexEvents<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_complex_event_dates(&self) -> Result<NoMDEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoMDEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup::new();
        Ok(NoMDEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoMDEntriesNoComplexEvents<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_complex_event_dates(&mut self, f: NoMDEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoMDEntriesNoComplexEventsRepeatingGroup` is the `NoComplexEvents` repeating group, Tag 1483.
pub struct NoMDEntriesNoComplexEventsRepeatingGroup(pub RepeatingGroup);

impl NoMDEntriesNoComplexEventsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoMDEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoMDEntriesNoComplexEvents<&mut Group> {
        NoMDEntriesNoComplexEvents(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoMDEntriesNoComplexEvents<&Group> {
        NoMDEntriesNoComplexEvents(self.0.get(i))
    }
...
impl Default for NoMDEntriesNoComplexEventsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
/// `NoStatsIndicators` is an entry in the `NoStatsIndicators` repeating group, Tag 1175.
pub struct NoMDEntriesNoStatsIndicators<G>(pub G);

impl<G: Borrow<Group>> NoMDEntriesNoStatsIndicators<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    /// Gets `StatsType`, Tag 1176.
    pub fn get_stats_type(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::StatsTypeField::new(0);
        self.group().field_map.get_field(tag::STATS_TYPE, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `StatsType` is present, Tag 1176.
    pub fn has_stats_type(&self) -> bool {
        self.group().field_map.has(tag::STATS_TYPE)
    }


}

impl<G: BorrowMut<Group>> NoMDEntriesNoStatsIndicators<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    /// Sets `StatsType`, Tag 1176.
    pub fn set_stats_type(&mut self, v: isize) {
        self.group_mut().field_map.set_field(tag::STATS_TYPE, fixer::fix_int::FIXInt::from(v));
    }
...
/// `NoMDEntriesNoStatsIndicatorsRepeatingGroup` is the `NoStatsIndicators` repeating group, Tag 1175.
pub struct NoMDEntriesNoStatsIndicatorsRepeatingGroup(pub RepeatingGroup);

impl NoMDEntriesNoStatsIndicatorsRepeatingGroup {
    /// Creates an empty `NoStatsIndicators` group with the template from the FIX spec.
    pub fn new() -> Self {
        let template: GroupTemplate = vec![


            group_element(tag::STATS_TYPE),


        ];
        Self(RepeatingGroup::new(tag::NO_STATS_INDICATORS, template))
    }

    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoMDEntriesNoStatsIndicators<&mut Group> {
        NoMDEntriesNoStatsIndicators(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoMDEntriesNoStatsIndicators<&Group> {
        NoMDEntriesNoStatsIndicators(self.0.get(i))
    }
...
impl Default for NoMDEntriesNoStatsIndicatorsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<G: Borrow<Group>> NoMDEntries<G> {
    ...
    pub fn get_no_complex_events(&self) -> Result<NoMDEntriesNoComplexEventsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoMDEntriesNoComplexEventsRepeatingGroup::new();
        Ok(NoMDEntriesNoComplexEventsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
    ...
    pub fn get_md_sub_book_type(&self) -> Result<isize, MessageRejectErrorEnum> {
        ...
        self.group().field_map.get_field(tag::MD_SUB_BOOK_TYPE, &mut fld.0)?;
        Ok(fld.value())
    }
    ...
    pub fn has_md_sub_book_type(&self) -> bool {
        self.group().field_map.has(tag::MD_SUB_BOOK_TYPE)
    }
    ...
    /// Gets `NoStatsIndicators`, Tag 1175.
    pub fn get_no_stats_indicators(&self) -> Result<NoMDEntriesNoStatsIndicatorsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoMDEntriesNoStatsIndicatorsRepeatingGroup::new();
        Ok(NoMDEntriesNoStatsIndicatorsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }


    /// Returns true if `NoStatsIndicators` is present, Tag 1175.
    pub fn has_no_stats_indicators(&self) -> bool {
        self.group().field_map.has(tag::NO_STATS_INDICATORS)
    }
...
impl<G: BorrowMut<Group>> NoMDEntries<G> {
    ...
    pub fn set_no_complex_events(&mut self, f: NoMDEntriesNoComplexEventsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    pub fn set_md_sub_book_type(&mut self, v: isize) {
        self.group_mut().field_map.set_field(tag::MD_SUB_BOOK_TYPE, fixer::fix_int::FIXInt::from(v));
    }
    ...
    /// Sets `NoStatsIndicators`, Tag 1175.
    pub fn set_no_stats_indicators(&mut self, f: NoMDEntriesNoStatsIndicatorsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
impl NoMDEntriesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoMDEntriesNoComplexEventsRepeatingGroup::new().0),
            ...
            group_element(tag::MD_SUB_BOOK_TYPE),
            ...
            Box::new(NoMDEntriesNoStatsIndicatorsRepeatingGroup::new().0),
