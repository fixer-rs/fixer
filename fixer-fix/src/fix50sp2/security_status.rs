...
impl SecurityStatus {
    ...
    pub fn set_first_px(&mut self, val: Decimal, scale: i32) {
        self.message.body.set_field(tag::FIRST_PX, fixer::fix_decimal::FIXDecimal { decimal: val, scale });
    }
    ...
    pub fn get_first_px(&self) -> Result<Decimal, MessageRejectErrorEnum> {
        ...
        self.message.body.get_field(tag::FIRST_PX, &mut fld.0)?;
        Ok(fld.value())
    }
    ...
    pub fn has_first_px(&self) -> bool {
        self.message.body.has(tag::FIRST_PX)
    }
    ...
    pub fn set_halt_reason_int(&mut self, v: isize) {
        self.message.body.set_field(tag::HALT_REASON_INT, fixer::fix_int::FIXInt::from(v));
    }
    ...
    pub fn get_halt_reason_int(&self) -> Result<isize, MessageRejectErrorEnum> {
        ...
        self.message.body.get_field(tag::HALT_REASON_INT, &mut fld.0)?;
        Ok(fld.value())
    }
    ...
    pub fn has_halt_reason_int(&self) -> bool {
        self.message.body.has(tag::HALT_REASON_INT)
    }
    ...
    /// Sets `SecurityTradingEvent`, Tag 1174.
    pub fn set_security_trading_event(&mut self, v: isize) {
        self.message.body.set_field(tag::SECURITY_TRADING_EVENT, fixer::fix_int::FIXInt::from(v));
    }

    /// Gets `SecurityTradingEvent`, Tag 1174.
    pub fn get_security_trading_event(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::SecurityTradingEventField::new(0);
        self.message.body.get_field(tag::SECURITY_TRADING_EVENT, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `SecurityTradingEvent` is present, Tag 1174.
    pub fn has_security_trading_event(&self) -> bool {
        self.message.body.has(tag::SECURITY_TRADING_EVENT)
    }
