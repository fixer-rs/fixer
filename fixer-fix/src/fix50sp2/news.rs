...
impl News {
    ...
    /// Sets `LanguageCode`, Tag 1474.
    pub fn set_language_code(&mut self, v: String) {
        self.message.body.set_field(tag::LANGUAGE_CODE, FIXString::from(v));
    }

    /// Gets `LanguageCode`, Tag 1474.
    pub fn get_language_code(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::LanguageCodeField::new(String::new());
        self.message.body.get_field(tag::LANGUAGE_CODE, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `LanguageCode` is present, Tag 1474.
    pub fn has_language_code(&self) -> bool {
        self.message.body.has(tag::LANGUAGE_CODE)
    }
    ...
    /// Sets `NewsCategory`, Tag 1473.
    pub fn set_news_category(&mut self, v: isize) {
        self.message.body.set_field(tag::NEWS_CATEGORY, fixer::fix_int::FIXInt::from(v));
    }

    /// Gets `NewsCategory`, Tag 1473.
    pub fn get_news_category(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::NewsCategoryField::new(0);
        self.message.body.get_field(tag::NEWS_CATEGORY, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `NewsCategory` is present, Tag 1473.
    pub fn has_news_category(&self) -> bool {
        self.message.body.has(tag::NEWS_CATEGORY)
    }




    /// Sets `NewsID`, Tag 1472.
    pub fn set_news_id(&mut self, v: String) {
        self.message.body.set_field(tag::NEWS_ID, FIXString::from(v));
    }

    /// Gets `NewsID`, Tag 1472.
    pub fn get_news_id(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::NewsIDField::new(String::new());
        self.message.body.get_field(tag::NEWS_ID, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `NewsID` is present, Tag 1472.
    pub fn has_news_id(&self) -> bool {
        self.message.body.has(tag::NEWS_ID)
    }
    ...
    pub fn set_no_lines_of_text(&mut self, f: NoLinesOfTextRepeatingGroup) {
        self.message.body.set_group(f.0);
    }

    /// Gets `NoLinesOfText`, Tag 33.
    pub fn get_no_lines_of_text(&self) -> Result<NoLinesOfTextRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoLinesOfTextRepeatingGroup::new();
        Ok(NoLinesOfTextRepeatingGroup(self.message.body.get_group(g.0)?))
    }
    ...
    /// Sets `NoNewsRefIDs`, Tag 1475.
    pub fn set_no_news_ref_i_ds(&mut self, f: NoNewsRefIDsRepeatingGroup) {
        self.message.body.set_group(f.0);
    }

    /// Gets `NoNewsRefIDs`, Tag 1475.
    pub fn get_no_news_ref_i_ds(&self) -> Result<NoNewsRefIDsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoNewsRefIDsRepeatingGroup::new();
        Ok(NoNewsRefIDsRepeatingGroup(self.message.body.get_group(g.0)?))
    }


    /// Returns true if `NoNewsRefIDs` is present, Tag 1475.
    pub fn has_no_news_ref_i_ds(&self) -> bool {
        self.message.body.has(tag::NO_NEWS_REF_I_DS)
    }
...
/// `NoLinesOfText` is an entry in the `NoLinesOfText` repeating group, Tag 33.
pub struct NoLinesOfText<G>(pub G);

impl<G: Borrow<Group>> NoLinesOfText<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoLinesOfText<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoLinesOfTextRepeatingGroup` is the `NoLinesOfText` repeating group, Tag 33.
pub struct NoLinesOfTextRepeatingGroup(pub RepeatingGroup);

impl NoLinesOfTextRepeatingGroup {
    /// Creates an empty `NoLinesOfText` group with the template from the FIX spec.
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
        ...
        Self(RepeatingGroup::new(tag::NO_LINES_OF_TEXT, template))
    }

    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoLinesOfText<&mut Group> {
        NoLinesOfText(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoLinesOfText<&Group> {
        NoLinesOfText(self.0.get(i))
    }
...
impl Default for NoLinesOfTextRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
/// `NoNewsRefIDs` is an entry in the `NoNewsRefIDs` repeating group, Tag 1475.
pub struct NoNewsRefIDs<G>(pub G);

impl<G: Borrow<Group>> NoNewsRefIDs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    /// Gets `NewsRefID`, Tag 1476.
    pub fn get_news_ref_id(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::NewsRefIDField::new(String::new());
        self.group().field_map.get_field(tag::NEWS_REF_ID, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `NewsRefID` is present, Tag 1476.
    pub fn has_news_ref_id(&self) -> bool {
        self.group().field_map.has(tag::NEWS_REF_ID)
    }




    /// Gets `NewsRefType`, Tag 1477.
    pub fn get_news_ref_type(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::NewsRefTypeField::new(0);
        self.group().field_map.get_field(tag::NEWS_REF_TYPE, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `NewsRefType` is present, Tag 1477.
    pub fn has_news_ref_type(&self) -> bool {
        self.group().field_map.has(tag::NEWS_REF_TYPE)
    }


}

impl<G: BorrowMut<Group>> NoNewsRefIDs<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    /// Sets `NewsRefID`, Tag 1476.
    pub fn set_news_ref_id(&mut self, v: String) {
        self.group_mut().field_map.set_field(tag::NEWS_REF_ID, FIXString::from(v));
    }
    ...
    /// Sets `NewsRefType`, Tag 1477.
    pub fn set_news_ref_type(&mut self, v: isize) {
        self.group_mut().field_map.set_field(tag::NEWS_REF_TYPE, fixer::fix_int::FIXInt::from(v));
    }
...
/// `NoNewsRefIDsRepeatingGroup` is the `NoNewsRefIDs` repeating group, Tag 1475.
pub struct NoNewsRefIDsRepeatingGroup(pub RepeatingGroup);

impl NoNewsRefIDsRepeatingGroup {
    /// Creates an empty `NoNewsRefIDs` group with the template from the FIX spec.
    pub fn new() -> Self {
        let template: GroupTemplate = vec![


            group_element(tag::NEWS_REF_ID),



            group_element(tag::NEWS_REF_TYPE),


        ];
        Self(RepeatingGroup::new(tag::NO_NEWS_REF_I_DS, template))
    }

    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoNewsRefIDs<&mut Group> {
        NoNewsRefIDs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoNewsRefIDs<&Group> {
        NoNewsRefIDs(self.0.get(i))
    }
...
impl Default for NoNewsRefIDsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
