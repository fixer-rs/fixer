...
impl NewOrderList {
    ...
    /// Sets `ContingencyType`, Tag 1385.
    pub fn set_contingency_type(&mut self, v: isize) {
        self.message.body.set_field(tag::CONTINGENCY_TYPE, fixer::fix_int::FIXInt::from(v));
    }

    /// Gets `ContingencyType`, Tag 1385.
    pub fn get_contingency_type(&self) -> Result<isize, MessageRejectErrorEnum> {
        let mut fld = field::ContingencyTypeField::new(0);
        self.message.body.get_field(tag::CONTINGENCY_TYPE, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `ContingencyType` is present, Tag 1385.
    pub fn has_contingency_type(&self) -> bool {
        self.message.body.has(tag::CONTINGENCY_TYPE)
    }
...
pub struct NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G>(pub G);

impl<G: Borrow<Group>> NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup` is the `NoComplexEventTimes` repeating group, Tag 1494.
pub struct NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup(pub RepeatingGroup);

impl NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimes<&mut Group> {
        NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimes(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimes<&Group> {
        NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimes(self.0.get(i))
    }
...
impl Default for NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoOrdersNoComplexEventsNoComplexEventDates<G>(pub G);

impl<G: Borrow<Group>> NoOrdersNoComplexEventsNoComplexEventDates<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_complex_event_times(&self) -> Result<NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup::new();
        Ok(NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoOrdersNoComplexEventsNoComplexEventDates<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_complex_event_times(&mut self, f: NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoOrdersNoComplexEventsNoComplexEventDatesRepeatingGroup` is the `NoComplexEventDates` repeating group, Tag 1491.
pub struct NoOrdersNoComplexEventsNoComplexEventDatesRepeatingGroup(pub RepeatingGroup);

impl NoOrdersNoComplexEventsNoComplexEventDatesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoOrdersNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoOrdersNoComplexEventsNoComplexEventDates<&mut Group> {
        NoOrdersNoComplexEventsNoComplexEventDates(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoOrdersNoComplexEventsNoComplexEventDates<&Group> {
        NoOrdersNoComplexEventsNoComplexEventDates(self.0.get(i))
    }
...
impl Default for NoOrdersNoComplexEventsNoComplexEventDatesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoOrdersNoComplexEvents<G>(pub G);

impl<G: Borrow<Group>> NoOrdersNoComplexEvents<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_complex_event_dates(&self) -> Result<NoOrdersNoComplexEventsNoComplexEventDatesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoOrdersNoComplexEventsNoComplexEventDatesRepeatingGroup::new();
        Ok(NoOrdersNoComplexEventsNoComplexEventDatesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoOrdersNoComplexEvents<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_complex_event_dates(&mut self, f: NoOrdersNoComplexEventsNoComplexEventDatesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoOrdersNoComplexEventsRepeatingGroup` is the `NoComplexEvents` repeating group, Tag 1483.
pub struct NoOrdersNoComplexEventsRepeatingGroup(pub RepeatingGroup);

impl NoOrdersNoComplexEventsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoOrdersNoComplexEventsNoComplexEventDatesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoOrdersNoComplexEvents<&mut Group> {
        NoOrdersNoComplexEvents(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoOrdersNoComplexEvents<&Group> {
        NoOrdersNoComplexEvents(self.0.get(i))
    }
...
impl Default for NoOrdersNoComplexEventsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<G: Borrow<Group>> NoOrders<G> {
    ...
    pub fn get_no_complex_events(&self) -> Result<NoOrdersNoComplexEventsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoOrdersNoComplexEventsRepeatingGroup::new();
        Ok(NoOrdersNoComplexEventsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoOrders<G> {
    ...
    pub fn set_no_complex_events(&mut self, f: NoOrdersNoComplexEventsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
impl NoOrdersRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoOrdersNoComplexEventsRepeatingGroup::new().0),
