...
pub struct NoQuoteEntriesNoEvents<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoEvents<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoEvents<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoQuoteEntriesNoEventsRepeatingGroup` is the `NoEvents` repeating group, Tag 864.
pub struct NoQuoteEntriesNoEventsRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoEventsRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoEvents<&mut Group> {
        NoQuoteEntriesNoEvents(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoEvents<&Group> {
        NoQuoteEntriesNoEvents(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoEventsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDs<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDs<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDsRepeatingGroup` is the `NoInstrumentPartySubIDs` repeating group, Tag 1052.
pub struct NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDsRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDsRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDs<&mut Group> {
        NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDs<&Group> {
        NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDs(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoInstrumentParties<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoInstrumentParties<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_instrument_party_sub_i_ds(&self) -> Result<NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDsRepeatingGroup::new();
        Ok(NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoInstrumentParties<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_instrument_party_sub_i_ds(&mut self, f: NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoQuoteEntriesNoInstrumentPartiesRepeatingGroup` is the `NoInstrumentParties` repeating group, Tag 1018.
pub struct NoQuoteEntriesNoInstrumentPartiesRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoInstrumentPartiesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoQuoteEntriesNoInstrumentPartiesNoInstrumentPartySubIDsRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoInstrumentParties<&mut Group> {
        NoQuoteEntriesNoInstrumentParties(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoInstrumentParties<&Group> {
        NoQuoteEntriesNoInstrumentParties(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoInstrumentPartiesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup` is the `NoComplexEventTimes` repeating group, Tag 1494.
pub struct NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<&mut Group> {
        NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes<&Group> {
        NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimes(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoComplexEventsNoComplexEventDates<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoComplexEventsNoComplexEventDates<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_complex_event_times(&self) -> Result<NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup::new();
        Ok(NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoComplexEventsNoComplexEventDates<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_complex_event_times(&mut self, f: NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup` is the `NoComplexEventDates` repeating group, Tag 1491.
pub struct NoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoQuoteEntriesNoComplexEventsNoComplexEventDatesNoComplexEventTimesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoComplexEventsNoComplexEventDates<&mut Group> {
        NoQuoteEntriesNoComplexEventsNoComplexEventDates(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoComplexEventsNoComplexEventDates<&Group> {
        NoQuoteEntriesNoComplexEventsNoComplexEventDates(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoComplexEvents<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoComplexEvents<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_complex_event_dates(&self) -> Result<NoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup::new();
        Ok(NoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoComplexEvents<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_complex_event_dates(&mut self, f: NoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoQuoteEntriesNoComplexEventsRepeatingGroup` is the `NoComplexEvents` repeating group, Tag 1483.
pub struct NoQuoteEntriesNoComplexEventsRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoComplexEventsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoQuoteEntriesNoComplexEventsNoComplexEventDatesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoComplexEvents<&mut Group> {
        NoQuoteEntriesNoComplexEvents(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoComplexEvents<&Group> {
        NoQuoteEntriesNoComplexEvents(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoComplexEventsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltID<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltID<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltID<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltIDRepeatingGroup` is the `NoUnderlyingSecurityAltID` repeating group, Tag 457.
pub struct NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltIDRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltIDRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltID<&mut Group> {
        NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltID(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltID<&Group> {
        NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltID(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltIDRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoUnderlyingsNoUnderlyingStips<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoUnderlyingsNoUnderlyingStips<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoUnderlyingsNoUnderlyingStips<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoQuoteEntriesNoUnderlyingsNoUnderlyingStipsRepeatingGroup` is the `NoUnderlyingStips` repeating group, Tag 887.
pub struct NoQuoteEntriesNoUnderlyingsNoUnderlyingStipsRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoUnderlyingsNoUnderlyingStipsRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoUnderlyingsNoUnderlyingStips<&mut Group> {
        NoQuoteEntriesNoUnderlyingsNoUnderlyingStips(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoUnderlyingsNoUnderlyingStips<&Group> {
        NoQuoteEntriesNoUnderlyingsNoUnderlyingStips(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoUnderlyingsNoUnderlyingStipsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup` is the `NoUndlyInstrumentPartySubIDs` repeating group, Tag 1062.
pub struct NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs<&mut Group> {
        NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs<&Group> {
        NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDs(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentParties<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentParties<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_undly_instrument_party_sub_i_ds(&self) -> Result<NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup::new();
        Ok(NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentParties<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_undly_instrument_party_sub_i_ds(&mut self, f: NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesRepeatingGroup` is the `NoUndlyInstrumentParties` repeating group, Tag 1058.
pub struct NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesNoUndlyInstrumentPartySubIDsRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentParties<&mut Group> {
        NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentParties(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentParties<&Group> {
        NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentParties(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoUnderlyings<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoUnderlyings<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_underlying_security_alt_id(&self) -> Result<NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltIDRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltIDRepeatingGroup::new();
        Ok(NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltIDRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
    ...
    pub fn get_no_underlying_stips(&self) -> Result<NoQuoteEntriesNoUnderlyingsNoUnderlyingStipsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoUnderlyingsNoUnderlyingStipsRepeatingGroup::new();
        Ok(NoQuoteEntriesNoUnderlyingsNoUnderlyingStipsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
    ...
    pub fn get_no_undly_instrument_parties(&self) -> Result<NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesRepeatingGroup::new();
        Ok(NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoUnderlyings<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_underlying_security_alt_id(&mut self, f: NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltIDRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    pub fn set_no_underlying_stips(&mut self, f: NoQuoteEntriesNoUnderlyingsNoUnderlyingStipsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    pub fn set_no_undly_instrument_parties(&mut self, f: NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoQuoteEntriesNoUnderlyingsRepeatingGroup` is the `NoUnderlyings` repeating group, Tag 711.
pub struct NoQuoteEntriesNoUnderlyingsRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoUnderlyingsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoQuoteEntriesNoUnderlyingsNoUnderlyingSecurityAltIDRepeatingGroup::new().0),
            ...
            Box::new(NoQuoteEntriesNoUnderlyingsNoUnderlyingStipsRepeatingGroup::new().0),
            ...
            Box::new(NoQuoteEntriesNoUnderlyingsNoUndlyInstrumentPartiesRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoUnderlyings<&mut Group> {
        NoQuoteEntriesNoUnderlyings(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoUnderlyings<&Group> {
        NoQuoteEntriesNoUnderlyings(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoUnderlyingsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoLegsNoLegSecurityAltID<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoLegsNoLegSecurityAltID<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoLegsNoLegSecurityAltID<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
...
/// `NoQuoteEntriesNoLegsNoLegSecurityAltIDRepeatingGroup` is the `NoLegSecurityAltID` repeating group, Tag 604.
pub struct NoQuoteEntriesNoLegsNoLegSecurityAltIDRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoLegsNoLegSecurityAltIDRepeatingGroup {
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoLegsNoLegSecurityAltID<&mut Group> {
        NoQuoteEntriesNoLegsNoLegSecurityAltID(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoLegsNoLegSecurityAltID<&Group> {
        NoQuoteEntriesNoLegsNoLegSecurityAltID(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoLegsNoLegSecurityAltIDRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct NoQuoteEntriesNoLegs<G>(pub G);

impl<G: Borrow<Group>> NoQuoteEntriesNoLegs<G> {
    fn group(&self) -> &Group {
        self.0.borrow()
    }
    ...
    pub fn get_no_leg_security_alt_id(&self) -> Result<NoQuoteEntriesNoLegsNoLegSecurityAltIDRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoLegsNoLegSecurityAltIDRepeatingGroup::new();
        Ok(NoQuoteEntriesNoLegsNoLegSecurityAltIDRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntriesNoLegs<G> {
    fn group_mut(&mut self) -> &mut Group {
        self.0.borrow_mut()
    }
    ...
    pub fn set_no_leg_security_alt_id(&mut self, f: NoQuoteEntriesNoLegsNoLegSecurityAltIDRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
/// `NoQuoteEntriesNoLegsRepeatingGroup` is the `NoLegs` repeating group, Tag 555.
pub struct NoQuoteEntriesNoLegsRepeatingGroup(pub RepeatingGroup);

impl NoQuoteEntriesNoLegsRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoQuoteEntriesNoLegsNoLegSecurityAltIDRepeatingGroup::new().0),
    ...
    /// Appends an entry and returns it for population.
    pub fn add(&mut self) -> NoQuoteEntriesNoLegs<&mut Group> {
        NoQuoteEntriesNoLegs(self.0.add())
    }

    /// Returns the `i`th entry.
    pub fn get(&self, i: usize) -> NoQuoteEntriesNoLegs<&Group> {
        NoQuoteEntriesNoLegs(self.0.get(i))
    }
...
impl Default for NoQuoteEntriesNoLegsRepeatingGroup {
    fn default() -> Self {
        Self::new()
    }
}
...
impl<G: Borrow<Group>> NoQuoteEntries<G> {
    ...
    pub fn get_no_events(&self) -> Result<NoQuoteEntriesNoEventsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoEventsRepeatingGroup::new();
        Ok(NoQuoteEntriesNoEventsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
    ...
    pub fn get_no_instrument_parties(&self) -> Result<NoQuoteEntriesNoInstrumentPartiesRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoInstrumentPartiesRepeatingGroup::new();
        Ok(NoQuoteEntriesNoInstrumentPartiesRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
    ...
    pub fn get_no_complex_events(&self) -> Result<NoQuoteEntriesNoComplexEventsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoComplexEventsRepeatingGroup::new();
        Ok(NoQuoteEntriesNoComplexEventsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
    ...
    pub fn get_no_underlyings(&self) -> Result<NoQuoteEntriesNoUnderlyingsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoUnderlyingsRepeatingGroup::new();
        Ok(NoQuoteEntriesNoUnderlyingsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
    ...
    /// Gets `NoLegs`, Tag 555.
    pub fn get_no_legs(&self) -> Result<NoQuoteEntriesNoLegsRepeatingGroup, MessageRejectErrorEnum> {
        let g = NoQuoteEntriesNoLegsRepeatingGroup::new();
        Ok(NoQuoteEntriesNoLegsRepeatingGroup(self.group().field_map.get_group(g.0)?))
    }
...
impl<G: BorrowMut<Group>> NoQuoteEntries<G> {
    ...
    pub fn set_no_events(&mut self, f: NoQuoteEntriesNoEventsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    pub fn set_no_instrument_parties(&mut self, f: NoQuoteEntriesNoInstrumentPartiesRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    pub fn set_no_complex_events(&mut self, f: NoQuoteEntriesNoComplexEventsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    pub fn set_no_underlyings(&mut self, f: NoQuoteEntriesNoUnderlyingsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
    ...
    /// Sets `NoLegs`, Tag 555.
    pub fn set_no_legs(&mut self, f: NoQuoteEntriesNoLegsRepeatingGroup) {
        self.group_mut().field_map.set_group(f.0);
    }
...
impl NoQuoteEntriesRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            Box::new(NoQuoteEntriesNoEventsRepeatingGroup::new().0),
            ...
            Box::new(NoQuoteEntriesNoInstrumentPartiesRepeatingGroup::new().0),
            ...
            Box::new(NoQuoteEntriesNoComplexEventsRepeatingGroup::new().0),
            ...
            Box::new(NoQuoteEntriesNoUnderlyingsRepeatingGroup::new().0),



            Box::new(NoQuoteEntriesNoLegsRepeatingGroup::new().0),
