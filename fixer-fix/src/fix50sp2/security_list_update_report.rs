...
impl<G: Borrow<Group>> NoRelatedSym<G> {
    ...
    /// Gets `ListUpdateAction`, Tag 1324.
    pub fn get_list_update_action(&self) -> Result<String, MessageRejectErrorEnum> {
        let mut fld = field::ListUpdateActionField::new(String::new());
        self.group().field_map.get_field(tag::LIST_UPDATE_ACTION, &mut fld.0)?;
        Ok(fld.value().to_string())
    }


    /// Returns true if `ListUpdateAction` is present, Tag 1324.
    pub fn has_list_update_action(&self) -> bool {
        self.group().field_map.has(tag::LIST_UPDATE_ACTION)
    }
    ...
    /// Gets `RelSymTransactTime`, Tag 1504.
    pub fn get_rel_sym_transact_time(&self) -> Result<Timestamp, MessageRejectErrorEnum> {
        let mut fld = field::RelSymTransactTimeField::new(Timestamp::UNIX_EPOCH);
        self.group().field_map.get_field(tag::REL_SYM_TRANSACT_TIME, &mut fld.0)?;
        Ok(fld.value())
    }


    /// Returns true if `RelSymTransactTime` is present, Tag 1504.
    pub fn has_rel_sym_transact_time(&self) -> bool {
        self.group().field_map.has(tag::REL_SYM_TRANSACT_TIME)
    }
...
impl<G: BorrowMut<Group>> NoRelatedSym<G> {
    ...
    /// Sets `ListUpdateAction`, Tag 1324.
    pub fn set_list_update_action(&mut self, v: String) {
        self.group_mut().field_map.set_field(tag::LIST_UPDATE_ACTION, FIXString::from(v));
    }
    ...
    /// Sets `RelSymTransactTime`, Tag 1504.
    pub fn set_rel_sym_transact_time(&mut self, v: Timestamp) {
        self.group_mut().field_map.set_field(tag::REL_SYM_TRANSACT_TIME, fixer::fix_utc_timestamp::FIXUTCTimestamp {
            time: v,
            precision: fixer::fix_utc_timestamp::TimestampPrecision::Millis,
        });
    }
...
impl NoRelatedSymRepeatingGroup {
    ...
    pub fn new() -> Self {
        let template: GroupTemplate = vec![
            ...
            group_element(tag::LIST_UPDATE_ACTION),
            ...
            group_element(tag::REL_SYM_TRANSACT_TIME),
